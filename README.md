...
*TBA* is a classic example of a blog website. 
Fully functional website that shows the list of posts and empower readers to interact with them by adding comments and liking posts.
...
- **Users can posts, comments and likes**
...
```sh
  cd my-folder
  git clone https://github.com/maov19/blog-app.git
```
...
Thanks to Microverse for the support and guidelines, and my coding partners for their amazing collaboration.
